...
import Zutateninput from './Zutateninput';
import Übersicht from './Übersicht';
import Rezepte from './Rezepte';
import Navigationsbar from "./Navigationsbar"
    ...
    render() {
        return (
            ...
            <BrowserRouter >
                <Navigationsbar/>
                    <Switch>
                        <Route path="/Übersicht" render={(props) => <Übersicht {...props}  shopping={this.state.shopping} ingredients={this.state.ingredients} />}/>
                        <Route path="/Rezept/:id" component={Rezepte}/>
                        <Route path="/" render={(props) => <Zutateninput {...props} shopping={this.state.shopping} deleteIngredients={this.deleteIngredients.bind(this)} 
